...
const modules: Module[] = [
  { id: 'users', label: 'User Management', icon: '👥', route: '/user-management', gradient: 'from-blue-500 to-indigo-600' },
  { id: 'revenue', label: 'Company Revenue', icon: '💰', route: '/revenue/accountant', gradient: 'from-yellow-500 to-orange-600' },
  { id: 'purchase', label: 'Purchase Requests', icon: '📋', route: '/purchase-requests', gradient: 'from-purple-500 to-pink-600' },
  { id: 'announcements', label: 'Announcements', icon: '📢', route: '/announcements', gradient: 'from-orange-500 to-red-600' },
  { id: 'audit', label: 'Security & Audit', icon: '🔐', route: '/activity-logs', gradient: 'from-slate-700 to-slate-900' },
];
...
export default function SuperAdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 p-8 flex flex-col">
      {/* Header */}
