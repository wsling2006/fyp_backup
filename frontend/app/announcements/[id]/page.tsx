...
const AnnouncementDetailPage: React.FC = () => {
  ...
  // SECURITY: Require login to view announcements
  useEffect(() => {
    if (!authLoading && isInitialized) {
      if (!user) {
        showToast('Please login to view announcements', 'error');
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Announcement Not Found</h1>
          <button
