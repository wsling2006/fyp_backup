...
const modules: Module[] = [
  ...
  { id: 'purchase', label: 'Purchase Requests', icon: '📋', route: '/purchase-requests', gradient: 'from-blue-500 to-indigo-600' },
  { id: 'files', label: 'Accountant Files', icon: '📁', route: '/accountant-files', gradient: 'from-purple-500 to-pink-600' },
...
export default function AccountantDashboard() {
  ...
  const [activeIndex, setActiveIndex] = useState(0); // Start with Revenue centered
