              ...
              >
                ...
                <div className="flex justify-between items-center p-6 border-b border-gray-100">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {/* Edit and Delete Buttons - Only for HR and Super Admin */}
                    {user && (user.role === 'human_resources' || user.role === 'super_admin') && (
                      <>
                        <button
                          onClick={() => router.push(`/announcements/${announcement.id}/edit`)}
                          className="flex items-center gap-1 px-3 py-1.5 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors border border-blue-200"
